$uri = "https://api.tinyfox.dev/img?animal=wah"
$destinationFolder = Join-Path -Path $env:USERPROFILE\Pictures -ChildPath "red panda"
...
for ($i = 1; $i -le $numberOfImages; $i++) {
    ...
    $destinationPath = Join-Path -Path $destinationFolder -ChildPath "wah_image_${i}_${timestamp}.jpg"
